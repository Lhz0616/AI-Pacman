...
public class NNTrainer {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        System.out.println("Total weights: " + weightsTotal);
        ...
        final Engine<DoubleGene, Double> engine = Engine
                ...
                .alterers(new MultiPointCrossover<>(0.5), new GaussianMutator<>(0.3))
                .build();


        final Genotype<DoubleGene> result = engine.stream()
                .limit(limit.byExecutionTime(Duration.ofMinutes(5)))
//                .limit(100)
                .peek(x -> {
                    System.setOut(out);
                    System.out.println("Generation: " + x.getGeneration() + "\tBest Fitness: " + x.getBestFitness() + "\tWorst Genome: " + x.getWorstFitness());
                    System.out.println();
                })
        ...
        saveModel(
                ...
                "target\\test-classes\\results\\model.txt"
        );
    }
