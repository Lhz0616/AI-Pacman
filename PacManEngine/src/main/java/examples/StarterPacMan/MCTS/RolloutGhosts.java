package examples.StarterPacMan.MCTS;
 ...
 */
public final class RolloutGhosts extends Controller<EnumMap<GHOST,MOVE>>
{	
	private final static float CONSISTENCY=0.50f;	//attack Ms Pac-Man with this probability
